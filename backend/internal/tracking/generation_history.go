...
// overwrites a prior record (story 13). The record is stamped at
// CurrentSchemaVersion, so its empty fields read as genuinely empty; the
// Application's own version is carried through unchanged.
